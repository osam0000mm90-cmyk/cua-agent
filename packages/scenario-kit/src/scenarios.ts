...
import { desktopDefaultPrompt } from "./desktop.js";
...
const scenarioCatalog = scenarioManifestSchema.array().parse([
  ...
  {
    id: "desktop-control-console",
    labId: "desktop",
    category: "automation",
    title: "Desktop Control Console",
    description:
      "General-purpose desktop operator console for terminal work, window control, and screen-driven tasks.",
    defaultPrompt: desktopDefaultPrompt,
    workspaceTemplatePath: templatePath("desktop-lab-template"),
    startTarget: {
      kind: "workspace_file",
      label: "desktop control console",
      path: "index.html",
    },
    defaultMode: "code",
    supportsCodeEdits: true,
    verification: [
      {
        id: "desktop-console-ready",
        kind: "desktop_ready",
        description:
          "The desktop control page loads successfully and the console is ready for operator tasks.",
      },
    ],
    tags: ["automation", "desktop", "telegram"],
  },
]);
