...
The desktop control console scenario keeps the browser page light and pushes real work through the runner's terminal and desktop tool layer. It is the preferred scenario for Telegram-first operation on low-RAM machines.
